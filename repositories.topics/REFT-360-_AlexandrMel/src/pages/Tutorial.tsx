        ...
        <IonSlides ref={slideRef} onIonSlideWillChange={handleSlideChangeStart} pager={false}>
          <IonSlide>
            ...
            <h2 className="slide-title">
              Welcome to <b>REFT360</b>
            </h2>
            <p>
              The <b>Real-time Feedback Tool app</b> is a Feedback tools that will help you and your collegues to easily share your feedback.
            </p>
          </IonSlide>

          <IonSlide>
            <img src="assets/img/ica-slidebox-img-2.png" alt="" className="slide-image" />
            <h2 className="slide-title">What is REFT360?</h2>
            <p>
              <b>Real Time Feedback Tool</b> is an open source SDK that enables developers to build high quality mobile apps with web technologies like HTML, CSS, and JavaScript.
            </p>
          </IonSlide>

          <IonSlide>
            <img src="assets/img/ica-slidebox-img-3.png" alt="" className="slide-image" />
            <h2 className="slide-title">What is REFT360 Appflow?</h2>
            <p>
              <b>REFT360 Appflow</b> is a powerful set of services and features built on top of Ionic Framework that brings a totally new level of app development agility to mobile dev teams.
            </p>
          </IonSlide>
